...
def find_object(action):
    objects_file = ET.ElementTree(file='../Slownik/Objekty.xml')  #ścieżka do pliku
    root = objects_file.getroot()

    for object_string in root.findall('objekt'):  # iteruje po wszystkich objektach
...
def main():
    ...
    if function.function_name == "Podnies":
        ...
        print (function.function_name , "(" , object.object_name , "," , paramater.parameter_name , ")")
